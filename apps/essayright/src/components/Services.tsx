const services = [
  ...
  },
  {
    title: "Applications",
    description:
      "Admissions essays, personal statements, scholarships, fellowships, and graduate school applications. We uncover your story and craft a narrative that gets you in.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
