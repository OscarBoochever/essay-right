...
export const metadata: Metadata = {
  ...
  description:
    "EssayRight helps students craft original, persuasive writing for admissions, academic work, and graduate study. Expert essay coaching and writing mentorship in the age of AI.",
  icons: {
    icon: "/favicon.ico",
