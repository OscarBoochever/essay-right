...
const bottomRow = [
  {
    ...
    description:
      "Executive bios, LinkedIn profiles, resumes, and cover letters. Tell the story of your career with clarity and confidence.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Strategic Communication Coaching",
    description:
